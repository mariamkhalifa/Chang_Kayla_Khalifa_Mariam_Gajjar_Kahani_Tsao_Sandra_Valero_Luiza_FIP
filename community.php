...
<body>
    ...
    <section class="more-community">
        ...
        <a href="#" target="_blank" class="button fill">See More Instagram</a>
    </section>
    ...
    <section class="share-story">
        ...
        <form class="story-form" action="" method="post">
            ...
            <textarea id="story" name="story" placeholder="My story is..." required></textarea>
            <input class="button purple-fill" type="submit" value="Submit">
    ...
    <section class="comm-help">
        ...
        <a hre="www.hivaidsconnection.ca/contact" target="_blank">www.hivaidsconnection.ca/contact</a>
    </section>
